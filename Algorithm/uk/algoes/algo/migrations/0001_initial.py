# Generated by Django 2.2.7 on 2020-09-28 03:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_img_content', models.ManyToManyField(related_name='recipe_order_img_content', to='algo.OrderImgContent')),
                ('order_ingre', models.ManyToManyField(related_name='recipe_order_ingre', to='algo.OrderIngre')),
            ],
        ),
        migrations.CreateModel(
            name='RefriIngre',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ingre_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='algo.Ingredient')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='algo.Recipe')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
