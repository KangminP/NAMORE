...
class Recipe(models.Model):
    ...
    order_img_content = models.ManyToManyField(
        OrderImgContent, related_name='recipe_order_img_content')
    order_ingre = models.ManyToManyField(
        OrderIngre, related_name='recipe_order_ingre')
